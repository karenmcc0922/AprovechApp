        ...
        <Link href={homeHref}>
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <div className="flex flex-col">
              ...
              {isRepartidor && (
                <span className="text-[8px] font-bold text-blue-600 tracking-widest leading-none mt-0.5">
                  REPARTIDOR
                </span>
              )}
            </div>
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                <Avatar className="h-full w-full rounded-full">
                  <AvatarFallback className={`text-white text-[10px] font-black w-full h-full flex items-center justify-center ${isRepartidor ? 'bg-blue-600' : 'bg-slate-900'}`}>
