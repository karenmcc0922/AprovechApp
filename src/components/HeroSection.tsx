...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-7xl px-6 pt-12 pb-16 grid lg:grid-cols-2 gap-12 items-center">
        {/* LEFT */}
        <div className="flex flex-col gap-6">
          <span
            className={`inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-100 text-emerald-700 text-sm font-semibold rounded-full border border-emerald-200 transition-all duration-700 ${
          ...
          <h1
            className={`text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight transition-all duration-700 delay-100 ${
              visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            Menos desperdicio.{" "}
          ...
          >
            <strong>AprovechApp</strong> conecta comercios con excedentes de alimentos con personas que quieren ahorrar hasta un{" "}
            <strong className="text-emerald-600">70%</strong>.
          </p>

          <div
            className={`flex gap-3 flex-col sm:flex-row transition-all duration-700 delay-300 ${
              visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            <button
          ...
          <div
            className={`flex gap-6 pt-2 transition-all duration-700 delay-500 ${
              visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
